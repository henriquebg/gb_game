...
;TO SECOND PARAMETER IN FOLLOWING LINE.
        ...
        WARN    "Version \1 or later of 'constantes.asm' is required."
        ENDC
        ENDM
...
_BORDA_SUPERIOR EQU $0F
_BORDA_INFERIOR EQU $92
_BORDA_DIREITA EQU $A0
_BORDA_DIREITA_OFFSET EQU $A8
_BORDA_INFERIOR_OFFSET EQU $9A
_BORDA_ESQUERDA EQU $09
